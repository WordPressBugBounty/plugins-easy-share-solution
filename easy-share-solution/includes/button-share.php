...
<button class="tottal-count bshare-' . esc_attr($name_one) . ' share s_' . esc_attr($name_one) . '" type="button">';
			if ($select_count !== 'no') :
			...
			$content .= '<i class="icon-' . esc_attr($name_one) . '"></i>&nbsp;' . esc_html($name_one) . '
			</button>
		</div>
		<div class="count-set-bottom ' . esc_attr($icononly) . '">
			<button class="tottal-count bshare-' . esc_attr($name_two) . ' share s_' . esc_attr($name_two) . '" type="button">';
			if ($select_count !== 'no') :
			...
			$content .= '<i class="icon-' . esc_attr($name_two) . '"></i>&nbsp;' . esc_html($name_two) . '
			</button>
		</div>
		<div class="count-set-bottom ' . esc_attr($icononly) . '">
		<button class="tottal-count bshare-' . esc_attr($name_three) . ' share s_' . esc_attr($name_three) . '" type="button">';
			if ($select_count !== 'no') :
			...
			$content .= '<i class="icon-' . esc_attr($name_three) . '"></i>&nbsp;' . esc_html($name_three) . '
			</button>
		</div>
		<div class="count-set-bottom ' . esc_attr($icononly) . '">
		<button class="tottal-count bshare-' . esc_attr($name_four) . ' share s_' . esc_attr($name_four) . '" type="button">';
			if ($select_count !== 'no') :
			...
			$content .= '<i class="icon-' . esc_attr($name_four) . '"></i>&nbsp;' . esc_html($name_four) . '
			</button>
		</div>
		<div class="count-set-bottom ' . esc_attr($icononly) . '">
		
			<button class="tottal-count bshare-' . esc_attr($name_five) . ' share s_' . esc_attr($name_five) . '" type="button">';
			if ($select_count !== 'no') :
			...
			$content .= '<i class="icon-' . esc_attr($name_five) . '"></i>&nbsp;' . esc_html($name_five) . '
			</button>
		</div>';
			if ($name_six !== 'noselected') :
				$content .= '<div class="count-set-bottom ' . esc_attr($icononly) . '">';
				if ($select_count !== 'no') :
				...
				$content .= '<button class="tottal-count bshare-' . esc_attr($name_six) . ' share s_' . esc_attr($name_six) . '" type="button">
				<i class="icon-' . esc_attr($name_six) . '"></i>&nbsp;' . esc_html($name_six) . '
			</button>
		</div>';
			endif;
			...
			<button class="tottal-count bshare-' . esc_attr($name_seven) . ' share s_' . esc_attr($name_seven) . '" type="button">';
				if ($select_count !== 'no') :
				...
				$content .= '<i class="icon-' . esc_attr($name_seven) . '"></i>&nbsp;' . esc_html($name_seven) . '
			</button>
		</div>';
			endif;
			if ($all_sharebtn == 'yes') :
	...
	function born_share_side()
	{
		...
		?>
			<div id="bshare-social" class="baby-sideshare share-left <?php if ($select_count == 'yes') : ?>count_show<?php endif; ?> <?php if ($btn_type == 'round_icon') : ?>round-icons<?php endif; ?>" style="top:<?php echo esc_attr($btn_top_set); ?>%">
				...
				<div class="count-set-left t-left <?php if ($btn_type == 'icon' || $btn_type == 'round_icon') : ?>text-left<?php endif; ?>">
					<button class="bshare-<?php echo esc_attr($name_three); ?> share s_<?php echo esc_attr($name_three); ?>" type="button">
						<?php echo esc_html($name_three); ?>&nbsp; <i class="icon-<?php echo esc_attr($name_three); ?>"></i>
						<?php if ($select_count !== 'no') : ?>
				...
				<div class="count-set-left t-left <?php if ($btn_type == 'icon' || $btn_type == 'round_icon') : ?>text-left<?php endif; ?>">
					<button class="bshare-<?php echo esc_attr($name_four); ?> share s_<?php echo esc_attr($name_four); ?>" type="button">
						<?php echo esc_html($name_four); ?>&nbsp; <i class="icon-<?php echo esc_attr($name_four); ?>"></i>
						<?php if ($select_count !== 'no') : ?>
				...
				<div class="count-set-left t-left <?php if ($btn_type == 'icon' || $btn_type == 'round_icon') : ?>text-left<?php endif; ?>">
					<button class="bshare-<?php echo esc_attr($name_five); ?> share s_<?php echo esc_attr($name_five); ?>" type="button">
						<?php echo esc_html($name_five); ?>&nbsp; <i class="icon-<?php echo esc_attr($name_five); ?>"></i>
						<?php if ($select_count !== 'no') : ?>
				...
				<?php if ($name_six !== 'noselected') : ?>
					<div class="count-set-left t-left <?php if ($btn_type == 'icon' || $btn_type == 'round_icon') : ?>text-left<?php endif; ?>">
						<button class="bshare-<?php echo esc_attr($name_six); ?> share s_<?php echo esc_attr($name_six); ?>" type="button">
							<?php echo esc_html($name_six); ?>&nbsp; <i class="icon-<?php echo esc_attr($name_six); ?>"></i>
							<?php if ($select_count !== 'no') : ?>
